...
$(document).ready(function() {
	...
	$('#btn-increase-version-asset').on('click', function(e) {
		...
		var path = '/recipe-app/api/version/' + assetType + '/' + assetId;
	...
	function createNewVersion(newVersion, assetId, assetType) {
		var path = '/recipe-app/api/version/' + assetType + '/' + assetId + '/' + newVersion;
	...
	function search() {
		...
		if (searchAssetString != "") {
			var link = '/recipe-app/assets/' + searchPrefix + '/?query=' + searchAssetString;
			window.location = link;
		}
	}
