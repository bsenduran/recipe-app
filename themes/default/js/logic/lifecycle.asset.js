...
$(function() {
  ...
  /*  $('#btn-asset-promote').on('click',function(e){
	 e.preventDefault();
	 console.log('/recipe-app/api/lifecycle/Promote/'+asset+'/'+id);
	 $.ajax({
	 url:'/recipe-app/api/lifecycle/Promote/'+asset+'/'+id,
	 type:'PUT',
	 success:function(response){
	 showAlert('Asset promoted successfully', 'success');

	 $.ajax({
	 url:'/recipe-app/api/lifecycle/'+asset+'/'+id,
	 type:'GET',
	 success:function(response){
  ...
  /*   $('#btn-asset-demote').on('click',function(e){
	 e.preventDefault();
	 $.ajax({
	 url:'/recipe-app/api/lifecycle/Demote/'+asset+'/'+id,
	 type:'PUT',
	 success:function(response){
  ...
  function buildLCGraph() {
    //alert(id);
    $.ajax({
      url: '/recipe-app/api/lifecycle/' + asset + '/' + id + '?t=' + new Date().getTime(),
      type: 'GET',
      success: function(response) {
        var element = $('#canvas');
        if (element) {
  ...
  function buttonClickLogic(action, comment) {
    $.ajax({
      url: '/recipe-app/apis/assets/' + id+ '/' +action+'?type='+asset,
      type: 'POST',
      data: JSON.stringify({
        'comment': comment
      }),
  ...
  function buildCheckList(asset, id) {
    ...
    $.ajax({
      url: '/recipe-app/api/lifecycle/checklist/' + asset + '/' + id,
      type: 'GET',
      success: function(response) {
  ...
  function buildHistory(asset, id) {
    ...
    var path = '/recipe-app/api/lifecycle/information/history/' + asset + '/' + id + '/' + version;
    $.ajax({
      url: path,
      type: 'GET',
      success: function(response) {
  ...
  function callCheckListItem(checkbox, checkListItemIndex) {
    $.ajax({
      url: '/recipe-app/api/lifecycle/checklistitem/' + checkListItemIndex + '/' + asset + '/' + id,
      type: 'POST',
      success: function(response) {
