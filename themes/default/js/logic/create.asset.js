$(function() {
	...
	var TAG_API_URL = '/recipe-app/api/tag/';
	...
	$('#overview_name').on('blur', function() {
		...
		$.ajax({
			url : '/recipe-app/api/validations/assets/' + type + '/overview_name/' + assetName,
			type : 'GET',
			success : function(response) {
 ...
 var options = { 
      ...
      // data : {"tags":tags},
        ...
        url:       '/recipe-app/asset/' + type,         // override for form's 'action' attribute 
