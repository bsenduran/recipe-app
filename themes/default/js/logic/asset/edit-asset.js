$(function() {
    ...
    var updateAsset = function(assetId, assetType, formData) {
        var url = '/recipe-app/api/asset/' + assetType + '/' + assetId;
        $.ajax({
            type: 'POST',
            url: url,
            data: formData,
                ...
                if (result.ok) {
                    ...
                    (function setupPermissions() {
                        ...
                        if (rolePermissions.length > 0) {
                            $.ajax({
                                url: '/recipe-app/asset/' + assetType + '/id/' + assetId + '/permissions',
                                type: 'POST',
                                processData: false,
    ...
    // roles autocomplete
    $('#roles').tokenInput('/recipe-app/api/lifecycle/information/meta/' + $('#meta-asset-type').val() + '/roles', {
        theme: 'facebook',
