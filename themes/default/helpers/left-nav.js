        ...
        [
           /*
           ...
           
            {
                ...
                url : "/recipe-app/asset/" + data.shortName + ""
            },
            {
                name: "Statistics",
                iconClass: "icon-dashboard",
                additionalClasses : (listPartial == "statistics" ) ? "prominent-link" : null,
                url: "/recipe-app/assets/statistics/" + data.shortName + "/"
            }
        ]
    };
    if(data.artifact){
            ...
            [
               /*
               ...
               
                {
                    ...
                    url : "/recipe-app/asset/operations/view/" + data.shortName + "/" + data.artifact.id + ""
                },
                {
                    name : "Edit",
                    iconClass : "icon-edit",
                     additionalClasses : (listPartial == "edit-asset" ) ? "prominent-link" : null,
                    url : "/recipe-app/asset/operations/edit/" + data.shortName + "/" + data.artifact.id + ""
                },
                {
                    name : "Life Cycle",
                    iconClass : "icon-retweet",
                     additionalClasses : (listPartial == "lifecycle-asset" ) ? "prominent-link" : null,
                    url : "/recipe-app/asset/operations/lifecycle/" + data.shortName + "/" + data.artifact.id + ""
                }
            ]
        };
    }
